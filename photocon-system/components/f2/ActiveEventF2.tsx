            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="relative">
                    ...
                    <div className="absolute -bottom-6 -right-2 md:bottom-8 md:-right-12 z-20 transform rotate-12 transition-transform hover:scale-110 hover:rotate-6 cursor-pointer group">
                        <div className="bg-brand-500 text-white p-6 w-32 h-32 md:w-40 md:h-40 rounded-[2rem] shadow-lg flex flex-col items-center justify-center border-4 border-white text-center relative rotate-3">
                            <span className="text-xl md:text-2xl font-bold font-maru leading-tight drop-shadow-md">
                                今すぐ<br />応募する
                            </span>
                            {/* Star Decoration */}
                            <Star className="text-yellow-300 w-8 h-8 absolute -top-4 -right-4 fill-current rotate-12" />
                            <Star className="text-yellow-300 w-6 h-6 absolute bottom-2 -left-4 fill-current -rotate-12" />
                        </div>
                    </div>
                </div>
