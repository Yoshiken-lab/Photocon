            ...
            <div className="max-w-6xl mx-auto relative">
                <div className="bg-gray-200 rounded-[3rem] overflow-hidden shadow-lg relative h-[500px] md:h-[600px] w-full">
                    ...
                    <div className="absolute top-12 left-10 md:left-24 z-10 select-none pointer-events-none h-[400px]" style={{ writingMode: 'vertical-rl' }}>
                        <h1 className="text-4xl md:text-5xl font-bold font-maru tracking-widest leading-relaxed drop-shadow-sm text-gray-800 py-4 px-16 bg-white/90 rounded-lg shadow-md mx-2 whitespace-nowrap">
                            あの日の一瞬を
                        </h1>
                        <h1 className="text-4xl md:text-5xl font-bold font-maru tracking-widest leading-relaxed drop-shadow-sm text-gray-800 py-4 px-16 mt-8 md:mt-12 bg-white/90 rounded-lg shadow-md mx-2 whitespace-nowrap">
                            未来の宝物に
                        </h1>
                    </div>
                </div>
