...
export default function SubmitPageO() {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#FFF5F0] flex items-center justify-center p-6 font-sans">
                <motion.div
    ...
    // --- Form View ---
    return (
        <div className="min-h-screen bg-[#FFF5F0] py-12 px-4 md:px-6 font-sans relative">
            {/* Background Decor */}
